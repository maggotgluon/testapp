        ...
        <section class="rounded-lg border border-zinc-200 dark:border-white/10 bg-white dark:bg-white/[0.04] p-6">
            ...
            <div class="mt-6 border-t border-zinc-200 dark:border-white/10 pt-6">
                ...
                <div class="mt-4 grid gap-4 sm:grid-cols-2">
                    <label class="text-sm text-zinc-700 dark:text-zinc-300">Bank name / ชื่อธนาคาร<input class="mt-1 w-full rounded-md border border-zinc-200 dark:border-white/10 bg-white dark:bg-zinc-950 px-3 py-2 text-zinc-950 dark:text-white" name="bank_name" value="{{ old('bank_name', $event->bank_name) }}"></label>
